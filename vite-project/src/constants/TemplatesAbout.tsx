...
export const TemplateTextInterest = () => {
  return (
    <TemplateAbout
...
export const TemplateTextPrimarySchool = () => {
  return (
    <TemplateAbout
      textOne={"Vítaj v sekcii moja základná škola"}
      textTwo={"Základnú školu som navštevoval na Základnej škole"}
      textThree={"Základná škola s materskou školou Milana Kolibiara"}
      textFour={
...
export const TemplateTextHighSchool = () => {
  return (
    <TemplateAbout
      textOne={"Vítaj v sekcii moja stredná škola"}
      textTwo={"Strednú školu som absolvoval na Strednej škole v Detve,"}
      textThree={"kde som študoval odbor CNC-nastavovač."}
      textFour={"Na tejto škole som sa naučil CNC technológie"}
      textFive={"a taktiež programovanie CNC strojov."}
